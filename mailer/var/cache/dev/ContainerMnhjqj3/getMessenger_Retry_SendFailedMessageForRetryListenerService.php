...
class getMessenger_Retry_SendFailedMessageForRetryListenerService extends Mailer_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.retry.send_failed_message_for_retry_listener'] = new \Symfony\Component\Messenger\EventListener\SendFailedMessageForRetryListener(($container->privates['.service_locator.zAB8nr4'] ?? $container->load('get_ServiceLocator_ZAB8nr4Service')), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'amqp_group' => ['privates', 'messenger.retry.multiplier_retry_strategy.amqp_group', 'getMessenger_Retry_MultiplierRetryStrategy_AmqpGroupService', true],
